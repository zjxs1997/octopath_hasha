...
// 在此基础上，改了一下part1的，（其实如果turn4 boost的话，是有可以结束战斗的）
// 另外增加了个一个往服务器发送信息的函数，可以通过服务器实时监视
...
while (1) {
    ...
    var text = "fight" + main_counter + "times,fail" + fail_counter;
    http.get("172.31.200.170:2021/?msg=" + text);
}
